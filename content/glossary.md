...
SICA
    Social Investigation and Class Analysis; data-driven methodology for
    understanding class composition at granular geographic levels.

Settler Colonialism
	A particular form of the general process of colonialism whereby a class of individuals called **settlers** systematically eradicate Indigenous nations with the intention of depopulating the land to be colonized and repopulated by the settlers. The expropriated land is brought into capitalist property relationships for repopulation, ownership, exploitation, and extraction of resources as the outcome of the expropriation and genocide. This contradiction represents an ongoing process which is never completed just as the contradiction between bourgeoisie and proletariat is never completed. This is because the contradiction is one between the settler class and the Indigenous population **over ownership and use of the land**.

super-profits
    Excess profits derived from imperialism and unequal exchange.

weighted edges
    Graph connections with numeric weights representing strength/frequency.

desire paths
    Trails created by actual usage rather than planned design; emergent structure.

Democratic centralism
    See {term}`democratic centralism`.
```
