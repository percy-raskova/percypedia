...
-- [Comrade Mao Zedong](https://www.marxists.org/reference/archive/mao/works/red-book/ch23.htm)
:::
...
-- [Comrade Mao Zedong](https://www.marxists.org/reference/archive/mao/works/red-book/ch22.htm)
:::
...
:::{warning}
However, there are a number of flaws in this line of this {doc}`left-deviation` argument which distort the truth and interpret it in the most opportunistic fashion.
:::
...
- {doc}`labor-aristocracy` -- The class dynamics underlying imperial complicity
- {doc}`political-police` -- Intelligence policing and counterinsurgency
- {doc}`functional-illiteracy` -- Barriers to political education
